...
const index_js$1 = require("telegram/events/index.js");
const index_js = require("telegram/sessions/index.js");
...
async function main() {
  try {
    const stringSession = new index_js.StringSession(session || "");
